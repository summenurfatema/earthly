...
<div data-aos="zoom-in" className='w-2/5 px-9'>
...
<div className='w-3/5 h-96 relative'>
     ...
     <img data-aos="fade-up"  src={kited} className='h-80 w-80 absolute top-32' alt='brush'/>
     <img data-aos="fade-right" src={cuped} className='h-80 w-96 absolute top-16 left-60' alt='brush'/>
     <img data-aos="fade-down" src={loffa} className='h-80 w-80 absolute top-0 right-12' alt='brush'/>
</div>
