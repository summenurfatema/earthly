...
AOS.init()
    ...
    <div data-aos="fade-down"  className='flex -space-x-20 justify-center items-center '>
...
{/* <p className='text-2xl text-gray-800 '>OUR TESTIMONIAL</p> */}
            <h1 className="p-4 text-2xl lg:text-4xl font-semibold text-center">What our customers are saying about us</h1>
        </div>
