...
const Testimonial = () => {
    const testimonials = [
        {
            ...
            "name": "Adam Smith",
            "review": "Bought this toothbrush online at less than $25 on sale and it works great. It keeps a charge for as long as a week. My Best Buy carries only much more expensive models, so I had to buy it at their site and have it shipped to the store."
        },
        {
            "id": 2,
            ...
            "name": "Jhon Deol",
            "review": "It is getting harder and harder to find paper cups in the store. I wanted cups that I could use in my restaurent and discard after only two or three uses. I am very glad to have them. I hate Styrofoam which is all I could find in the store.."
        },
        {
            "id": 3,
    ...
    <div className='flex -space-x-20 justify-center items-center '>
        ...
        <div className="container flex flex-col items-center mx-auto mb-1 md:p-10 md:px-12 lg:-mt-14">
{/* <p className='text-2xl text-gray-800 '>OUR TESTIMONIAL</p> */}
        ...
        <div className="container flex flex-col items-center justify-center mx-auto lg:flex-row lg:flex-wrap lg:justify-evenly lg:px-10">
            ...
            {
                testimonials.map(testimonial => <div className="flex flex-col max-w-sm mx-4 my-6 border shadow-gray-300 shadow-lg">
                    <div className="px-4 py-12 rounded-t-lg sm:px-8 md:px-12">
                        ...
                        <p className="relative px-6 py-1 text-lg text-center">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" fill="currentColor" className="w-8 h-8 text-yellow-600">
                                <path d="M232,246.857V16H16V416H54.4ZM48,48H200V233.143L48,377.905Z"></path>
                                <path d="M280,416h38.4L496,246.857V16H280ZM312,48H464V233.143L312,377.905Z"></path>
                            </svg>
                            <p>{testimonial.review}</p>
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" fill="currentColor" className="absolute right-0 w-8 h-8 text-yellow-600">
