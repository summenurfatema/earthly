    ...
    return (
        <div>
              <div className='flex -space-x-20 justify-center items-center '>
                ...
                <h1 className='text-4xl font-bold'>Our Growth Scale</h1>
            </div>
<section className="p-6 my-6 dark:bg-gray-800 dark:text-gray-100">
	<div className="container grid grid-cols-1 gap-6 mx-auto sm:grid-cols-2 xl:grid-cols-4">
		<div className="flex p-4 space-x-4 rounded-lg md:space-x-6 text-gray-900 bg-gray-100">
			<div className="flex justify-center p-2 align-middle rounded-lg sm:p-4 bg-violet-300">
